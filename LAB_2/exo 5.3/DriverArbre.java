...
public class DriverArbre extends Configured implements Tool{
    public static void main(String[] args) throws Exception {
 
        System.out.println("driver main() args: " + Arrays.toString(args));
        int res = ToolRunner.run(new Configuration(), new DriverArbre(), args);
    ...
    public int run(String[] args) throws Exception {
        ...
        job1.setMapperClass(MapperType.class);
        job1.setReducerClass(ReducerType.class);
